...
public abstract class BaseCheckException extends Exception {
     ...
     * @since 1.4
     */
    public BaseCheckException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.7
     */
    public BaseCheckException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {

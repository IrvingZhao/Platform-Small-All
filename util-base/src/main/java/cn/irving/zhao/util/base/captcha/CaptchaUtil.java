...
import cn.irving.zhao.util.base.random.RandomStringUtil;
...
public class CaptchaUtil {
    ...
    private static final CaptchaUtil me = new CaptchaUtil();

    private CaptchaUtil() {
    }

    /**
     * 生成验证码，宽高比建议大于 length/2+0.5
     *
     * @param w      宽
     * @param h      高
     * @param length 验证码长度
    ...
    public static Captcha generateCaptcha(int w, int h, int length) {
        ...
        return generateCaptcha(w, h, code);
    }

    /**
     * 生成验证码，宽高比建议大于 验证码长度/2+0.5
     *
     * @param w    宽
     * @param h    高
     * @param code 验证码
    ...
    private BufferedImage generateImage(int w, int h, String code) {
